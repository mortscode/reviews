...
namespace mortscode\reviews\widgets;

use mortscode\reviews\Reviews;
use mortscode\reviews\assetbundles\reviewswidgetwidget\ReviewsWidgetWidgetAsset;
...
class ReviewsWidget extends Widget
{
    ...
    {
        return Craft::getAlias("@mortscode/reviews/assetbundles/reviewswidgetwidget/dist/img/ReviewsWidget-icon.svg");
    }
