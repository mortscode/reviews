...
class Install extends Migration
{
    ...
    // reviews_reviewsrecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%reviews_reviewsrecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%reviews_reviewsrecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    {
    // reviews_reviewsrecord table
        $this->createIndex(null, '{{%reviews_reviewsrecord}}', 'entryId', false);
    }
    ...
    // reviews_reviewsrecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%reviews_reviewsrecord}}', 'siteId'),
            '{{%reviews_reviewsrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // reviews_reviewsrecord table
        $this->dropTableIfExists('{{%reviews_reviewsrecord}}');
    }
}
