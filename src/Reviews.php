...
class Reviews extends Plugin
{
    ...
    public function init()
    {
        ...
        $this->setComponents([
            'reviews' => ReviewsServiceService::class,
        ]);
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'reviews/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['reviews/entries/<entryId:\d+>'] = ['template' => 'reviews/cp/_list'];
                $event->rules['reviews/entries/<entryId:\d+>/<reviewId:\d+>'] = ['template' => 'reviews/cp/_detail'];
            }
        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = ReviewsWidgetWidget::class;
            }
        );
